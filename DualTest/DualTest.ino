...
MCP_CAN CAN0(3);                              // CAN0 interface usins CS on digital pin 2
MCP_CAN CAN1(4);                               // CAN1 interface using CS on digital pin 3

#define CAN0_INT 1    //define interrupt pin for CAN0 recieve buffer
